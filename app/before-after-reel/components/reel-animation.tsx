...
const rightLogo = 'https://www.allmaxnutrition.com/cdn/shop/files/logo-white_198x_9f614dcb-81f7-4460-8097-1190cf32eb03_400x.webp?v=1674804703'; // Right side logo - update this path
        ...
        >
          ...
          >
            ...
            >
              <div className="relative w-32 h-32 rounded-full bg-white/10 backdrop-blur-sm p-1">
                <div className="w-full h-full rounded-full bg-gradient-to-br from-white/20 to-white/5 flex items-center justify-center">
                  <div className="text-3xl font-bold text-white">BA</div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.p
              ...
              variants={item}
            >
              Create Stunning Before & After Reels
            </motion.p>
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className="relative aspect-[9/16] w-full">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                <h3 className="text-2xl font-bold text-white">{beforeText}</h3>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative aspect-[9/16] w-full">
              ...
              />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                <h3 className="text-2xl font-bold text-white">{afterText}</h3>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        >
          <p className="text-white/80 text-lg font-medium">Swipe to see the transformation</p>
        </motion.div>
      </div>
    </motion.div>
  );
